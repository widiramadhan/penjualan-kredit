...
public class TransaksiDataKreditur extends javax.swing.JDialog {
    ...
    private String[]label={"Id Kreditur","Nama Lengkap","Nomor Identitas","Pekerjaan","Email","Nomor Telepon"};
    ...
    public void BacaTabelKreditur(){
        try{
            String sql="select * from kreditur A, data_pekerjaan B WHERE B.id_kreditur=A.id_kreditur order by nama_lengkap_kreditur asc";
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/penjualan/kredit/gambar/data_kreditur.png"))); // NOI18N
